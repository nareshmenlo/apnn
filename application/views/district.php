<style type="text/css">
    ...
    #ccr-category-1 ul.mostpopular_news li{
        clear: both;
        margin:3px;
        width: 100%;
...
<section id="ccr-left-section" class="col-md-8">
    ...
    <div class="current-page">
        <a href="<?php echo base_url(); ?>"><i class="fa fa-home"></i> <i class="fa fa-angle-double-right"></i></a> District News
    </div> <!-- / .current-page -->
    ...
    <section id="ccr-category-1">
        <ul class="mostpopular_news">
            ...
            if (count($district) > 0) {
                    ...
                    <li>
                        ...
                        <div class="brief_box">
                            <div class="brief_title">
                                <a class="pull-left" style="font-weight:bold;" href="<?php echo base_url('district/single/' . $t->id.'/'.$articletitle); ?>"><?php echo $t->title; ?></a>
                            </div>
                            <div style="" class="pull-left">
                                ...
                                if ($t->image != '') {
                                    $leftdesc = 120;
                                    ?>
                                    <a href="<?php echo base_url('district/single/' . $t->id.'/'.$articletitle); ?>">
                ...
                ?>
                <li>district News are not available</li>
        <?php } ?> 
        </ul>
